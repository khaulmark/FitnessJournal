...
public class VideoProvider extends ContentProvider {
    ...
    private static String LOGTAG = "VideoProvider:";
    // Database Name for SQLITE DB
    private static final String DBNAME = "VideoDB";
    // Authority is the package name
    private static final String AUTHORITY = "com.example.fitnessjournal.Models.VideoProvider";
    //TABLE_NAME is defined as VideoTable
    ...
    public static final String VIDEO_TABLE_COL_ID = "_ID";
    public static final String VIDEO_TABLE_COL_FIREBASE_ID = "FIREBASE_ID";
    public static final String VIDEO_TABLE_COL_FILENAME = "FILENAME";
    ...
    private static final String SQL_CREATE_MAIN = "CREATE TABLE " +
            ...
            VIDEO_TABLE_COL_ID + " INTEGER PRIMARY KEY, " +
            VIDEO_TABLE_COL_FIREBASE_ID + " TEXT, " +
