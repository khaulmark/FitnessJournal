...
public class JournalProvider extends ContentProvider {
    ...
    private static String LOGTAG = "JournalProvider:";
    // Database Name for SQLITE DB
    private static final String DBNAME = "JournalDB";
    // Authority is the package name
    private static final String AUTHORITY = "com.example.fitnessjournal.Models.JournalProvider";
    //TABLE_NAME is defined as VideoFitnessJournal
    private static final String TABLE_NAME = "VideoFitnessJournal";
    //Create a CONTENT_URI for use by other classes
    public static final Uri CONTENT_URI =
            Uri.parse("content://" + AUTHORITY + "/"+TABLE_NAME);

    //Column names for the VideoFitnessJournal Table
    public static final String JOURNAL_TABLE_COL_ID = "_ID";
    public static final String JOURNAL_TABLE_COL_FIREBASE_ID = "FIREBASE_ID";
    public static final String JOURNAL_TABLE_COL_USERNAME = "USERNAME";
    public static final String JOURNAL_TABLE_COL_PROGRAM = "PROGRAM";

    //Table create string based on column names
    private static final String SQL_CREATE_MAIN = "CREATE TABLE " +
            TABLE_NAME+ " " +                       // Table's name
            "(" +                           // The columns in the table
            JOURNAL_TABLE_COL_ID + " INTEGER PRIMARY KEY, " +
            JOURNAL_TABLE_COL_FIREBASE_ID + " TEXT, " +
            JOURNAL_TABLE_COL_USERNAME + " TEXT, " +
            JOURNAL_TABLE_COL_PROGRAM + " TEXT) ";
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        switch (sUriMatcher.match(uri)){
            ...
            case 2:
                ...
                selection = JOURNAL_TABLE_COL_ID + "=" + id +
    ...
    public String getType(Uri uri) {
        // MARKER: Implement this to handle requests for the MIME type of the data
        // at the given URI.
    ...
    protected static final class MainDatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int int1, int int2){
            db.execSQL("DROP TABLE IF EXISTS VideoFitnessJournal");
            onCreate(db);
        }
    }
